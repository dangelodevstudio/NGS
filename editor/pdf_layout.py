...
def get_layout() -> ReportLayout:
    ...
    fields = {
        ...
        "footer.analyst": _field(27.21, 247.70, 145.14, 4.10, 9.0, 10.0, color="purple", font_name="bold"),
        "footer.tech": _field(27.21, 251.40, 145.14, 4.10, 9.0, 10.0, color="purple", font_name="bold"),
        "footer.md": _field(27.21, 255.10, 145.14, 4.10, 9.0, 10.0, color="purple", font_name="bold"),
        "footer.director": _field(27.21, 258.81, 145.14, 4.10, 9.0, 10.0, color="purple", font_name="bold"),
    }
